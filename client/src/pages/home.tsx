...
const Home = () => {
  ...
  const renderUserGreeting = () => {
    ...
    return (
      <>
        ...
        <h1 className="text-gray-500 text-sm">{getGreetingByTime()}</h1>
  ...
  return (
    <>
      ...
      <div className="flex max-sm:flex-wrap w-full min-h-screen">
        {/* <div className="w-full bg-white m-2 rounded-lg border shadow-lg p-4"> */}
        <div className="flex-1 bg-white m-2 rounded-lg border shadow-lg p-4 flex flex-col">
          <div>
            <div className="flex">
